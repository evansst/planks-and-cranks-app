...
export default function checkoutPage() {
  ...
  <div class="py-5 text-center">
    <img class="d-block mx-auto mb-4" src="../logos/Planks & Cranks-logo (1).png" alt="" width="600">
    <h2>Checkout</h2>
  </div>
    ...
    <div class="col-md-4 order-md-2 mb-4">
      ...
      <form class="card p-2">
        <div class="input-group">
          <button id="empty-cart" type="button" class="btn btn-secondary btn-block m-4">Empty Cart</button>
        </div>
      </form>
    </div>
